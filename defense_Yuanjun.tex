...
\end{center}
%https://commons.wikimedia.org/wiki/File%3ABrain_human_sagittal_section.svg
\end{frame}
...
\end{minipage}
&
\visible<2->{\Large $\Leftarrow$}
&
\visible<2->{
\begin{minipage}{0.30\textwidth}
%\begin{center}
\includegraphics[width = 0.6\textwidth]{./figs/overview/Ape-Cartoon-Chimpanzee-Monkey-Animal-Chimp-Cute-474147.png}
%\end{center}
\end{minipage}
}
\\
...
{\Large $\Downarrow$}&&\\
\begin{minipage}{0.5\textwidth}
\includegraphics[width = 1.0\textwidth]{./figs/overview/spike_train_data.png}
\end{minipage}}
&
\multicolumn{2}{l}{
\visible<4->{
...
%$\Rightarrow$
%&\\
%\includegraphics[width = 0.25\textwidth]{./figs/overview/Zebrafish_embryos.png}
\end{tabular}
%}
\end{center}
\end{frame}
...
\begin{itemize}
\item \alert{Normalizing flow}: A parameterized family of \alert{smooth and invertible} transformation. %\[\mathcal{F}=\{f_\phi:  \mathbb{R}^d \rightarrow \mathbb{R}^d, \phi \in \mathbb{R}^q\}.\]
