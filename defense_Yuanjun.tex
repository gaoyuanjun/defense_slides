...
\begin{frame}
\frametitle{Application example: neuroscience}
\end{frame}

\begin{frame}
\frametitle{Application example: texture modeling}
\end{frame}
...
\item Future work
\begin{itemize}
\item Normalizing flow structure
